...
namespace TagsCloudVisualization
{
	...
	{
		private const double DensityCoefficient = 1 / 6.28226;
		...
		internal static Point ToCartesianCoordinateSystem(double radius, double angle, Point center)
		{
		...
		internal static int RoundCoordinate(double value, int centerCoordinate)
		{
			if (value > 0)
