...
namespace TagCloudTests
{
    public class Tests
    {
        ...
        public void CircularCloudLayouter_IsFirstRectInCenter()
        {
            ...
            resultRect.Location.Should().Be(new Point(48, 48));
        }

        [Test]
        public void PutNextRectangle_ThrowsException_WhenAnyCoordIsNegative()
        {
            var cloudLayouter = new CircularCloudLayouter(new Point(0, 0));
            Assert.Throws<Exception>(() => cloudLayouter.PutNextRectangle(new Size(5, 5)));
        }
