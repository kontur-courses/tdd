...
public class CloudDrawerTests
{
    ...
    {
        new TestCaseData(new Cloud(new Point(0, 0), new List<Rectangle> { new(1, 1, 1, 1) }), 0, 1)
            .SetName("WhenGivenNotPositiveWidth"),
        new TestCaseData(new Cloud(new Point(0, 0), new List<Rectangle> { new(1, 1, 1, 1) }), 1, 0)
            .SetName("WhenGivenNotPositiveHeight"),
        new TestCaseData(new Cloud(new Point(0, 0), new List<Rectangle> { new(1, 1, 1, 1) }), 0, 0)
            .SetName("WhenGivenNotPositiveHeightAndWidth"),
    ...
    {
        new TestCaseData(new Cloud(new Point(5, 5), new List<Rectangle> { new(5, 5, 20, 3) }), 10, 10)
            .SetName("WhenCloudWidthIsGreaterThanImageWidth"),
        new TestCaseData(new Cloud(new Point(5, 5), new List<Rectangle> { new(5, 5, 3, 20) }), 10, 10)
            .SetName("WhenCloudHeightIsGreaterThanImageHeight"),
        new TestCaseData(new Cloud(new Point(5, 5), new List<Rectangle> { new(5, 5, 20, 20) }), 10, 10)
