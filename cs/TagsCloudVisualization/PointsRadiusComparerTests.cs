...
namespace TagsCloudVisualization
{
    public class PointsRadiusComparerTests
    {
        ...
        [TestCase(0, 0, 1, -1, 1, 1, TestName = "IfDistancesAreEqualAndX-CoordinatesAreEqualAndFirstPointYLessTnanSecondPointY")]
        ...
        [TestCase(0, 0, 1, 1, 1, -1, TestName = "IfDistancesAreEqualAndX-CoordinatesAreEqualAndFirstPointYBiggerTnanSecondPointY")]
