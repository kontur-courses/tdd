...
namespace TagsCloudVisualization
{
    ...
    public class RectangleExtensions_Should
    {
        ...
        {
            var rect = new RectangleF(50, 50, 50, 50);
            var rectangles = new List<RectangleF>();
            rectangles.Add(new RectangleF(0, 50, 49, 50));
            rectangles.Add(new RectangleF(50, 101, 50, 50));
            rectangles.Add(new RectangleF(52, 52, 48, 48));
            rectangles.Add(new RectangleF(50, 0, 50, 49));
        ...
        public void AreIntersected_ShouldReturnFalse_WhenRectangleNotIntersectedWithRectangles()
        {
            var rect = new RectangleF(50, 50, 50, 50);
            var rectangles = new List<RectangleF>();
            rectangles.Add(new RectangleF(101, 50, 50, 50));
            rectangles.Add(new RectangleF(0, 50, 49, 50));
            rectangles.Add(new RectangleF(50, 101, 50, 50));
            rectangles.Add(new RectangleF(50, 0, 50, 49));
        ...
        {
            var rectangles = new List<RectangleF>();
            rectangles.Add(new RectangleF(50, 50, 50, 50));
            rectangles.Add(new RectangleF(0, 50, 49, 50));
            rectangles.Add(new RectangleF(50, 101, 50, 50));
            rectangles.Add(new RectangleF(52, 52, 48, 48));
            rectangles.Add(new RectangleF(50, 0, 50, 49));
