...
{
    public static class RectanglesExtension
    {
        public static bool
        ...
        public static IEnumerable<Rectangle> GetAllPossibleRectanglePosition(Point corner, Size size)
        {
        ...
        public static IEnumerable<Point> CornersOfRectangles(Rectangle rectangle)
        {
