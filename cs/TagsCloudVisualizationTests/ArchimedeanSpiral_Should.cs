...
namespace TagsCloudVisualizationTests
{
    public class ArchimedeanSpiral_Should
    {
        ...
        {
            ArchimedeanSpiral archSpiral = new(step:1, density:1, start:0);
            var actual = GetPoints(archSpiral, border:6);
        ...
        {
            ArchimedeanSpiral archSpiral = new(step:1, density:3, start:5);
            var actual = GetPoints(archSpiral, border:6);
        ...
        {
            ArchimedeanSpiral archSpiral = new ArchimedeanSpiral(step, density, start);
