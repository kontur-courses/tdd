...
namespace TagsCloud.Tests
{
    ...
    public class TestDataGenerator : IEnumerable<TestCaseData>
    {
        public IEnumerator<TestCaseData> GetEnumerator()
        {
            ...
            yield return new TestCaseData("test test test", new Dictionary<string, int> {{"test", 3}}).SetName("Simple text");
            yield return new TestCaseData("test Test TEST", new Dictionary<string, int> {{"test", 3}}).SetName("Different case");
            yield return new TestCaseData("test,test,test", new Dictionary<string, int> {{"test", 3}}).SetName("Separated by comma");
            yield return new TestCaseData("test\ntest\ntest", new Dictionary<string, int> {{"test", 3}}).SetName("Separated by new line");
            yield return new TestCaseData("hello world hello world", new Dictionary<string, int> {{"hello", 2}, {"world", 2}})
            ...
            yield return new TestCaseData("Another brick in the wall", new Dictionary<string, int> {{"another", 1}, {"brick", 1}, {"wall", 1}})
