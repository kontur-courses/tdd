...
{
    public class LayouterPainter: IPainter<Rectangle>
    {
        ...
        public LayouterPainter(int width, int height, List<Rectangle> rectangles, string fileName, ImageFormat format)
        {
            offsetX = width/2;
            offsetY = height/2;
            this.format = format;
