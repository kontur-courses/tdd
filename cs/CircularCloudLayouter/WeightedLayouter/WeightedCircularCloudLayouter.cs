...
public class WeightedCircularCloudLayouter : ICircularCloudLayouter
{
    ...
    public WeightedCircularCloudLayouter(Point center) : this(center, FormFactors.Square)
    {
    }
    ...
    public Rectangle PutNextRectangle(Size rectSize)
    {
        ...
        foreach (var sideLayouter in _sideLayouters)
            sideLayouter.UpdateWeights(rect);
