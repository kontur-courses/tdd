...
namespace TagsCloudVisualization
{
    public class RectangleGeometry
    {
        ...
        public PointF CheckCircleForm(List<Rectangle> rectangles, Point center)
        {
             ...
             * Исходя из метода построения итоговой фигуры, в результате которого должен получиться круг, можно 
             * примерно понять где находится центр итоговой фигуры и куда вытянута окружность с центром в точке center
             */
            float all_squares = 0;
            float all_x = 0;
            float all_y = 0;
